...
public class MainActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (!PlaceItUtil.loginFlag) {
			// On create try to login first
			Intent loginIntent = new Intent(this, LoginManager.class);
			startActivity(loginIntent);
			PlaceItUtil.loginFlag = true;
		}
		...
		OnlineLocalDatabaseSynchronization olds = new OnlineLocalDatabaseSynchronization(
				this);
